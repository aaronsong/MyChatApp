...
public class ChatActivity extends AppCompatActivity {
    ...
    public static final String USER_ID_KDEY = "userId";
    ...
    private void getCurrentUser() {
        curentUserId = ParseUser.getCurrentUser().getObjectId();
        messagePosting();
    }
    ...
    private void messagePosting() {
        ...
        mAdapter = new ChatAdapter(ChatActivity.this, curentUserId, mMessages);
